...
# Get results for MatchDG Phase 2
    ...
    script= base_script + ' --dataset ' + str(args.dataset) + ' --domain_abl ' + str(args.domain_abl) + ' --test_metric ' + str(args.test_metric)
    os.system(script)
