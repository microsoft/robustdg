...
class PrivacyEntropy(BaseEval):
    ...
    def eval_entropy_attack(self, data, threshold_data, case='train'):
...
#                 print('Neg term: ', (F_i*torch.log(1.0-F_i)).shape, F_i[0])
    ...
    def get_metric_eval(self):
        ...
        train_metric= self.eval_entropy_attack(train_attack_data, threshold_data, 'train')
#         print('Threshold after training')
#         for y_c in range(self.args.out_classes):
#             print( 'Label : ', y_c, threshold_data[y_c] )
        test_metric= self.eval_entropy_attack(test_attack_data, threshold_data, 'test')
